                            ...
                            var filteredRooms = MERORS.Entities.FilteredCollection({
                                ...
                                filterFunction: function(filterCriterion) {
                                    ...
                                    return function(room) {
                                        if (room.get('roomName').toLowerCase().indexOf(criterion) !== -1 || room.get('roomCapacity').toLowerCase().indexOf(criterion) !== -1 || room.get('roomDescription').toLowerCase().indexOf(criterion) !== -1) {
                                            return room;
                                        }
                                    };
                                }
