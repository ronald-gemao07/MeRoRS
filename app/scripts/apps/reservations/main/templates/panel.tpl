...
<button class="btn btn js-day-view">Day View</button>
<button class="btn btn js-week-view">Week View</button>
<form id="filter-form" class="form-search form-inline pull-right">
  <div class="input-append">
    ...
    <button type="submit" class="btn">Filter reservations</button>
  </div>
</form>